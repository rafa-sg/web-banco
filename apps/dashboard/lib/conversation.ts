...
export const highlightedEvents: Record<string, { label: string; tone: EventTone }> = {
  ...
  handoff_created: { label: "WhatsApp programado (esperando que el cliente escriba CONTINUAR)", tone: "info" },
  whatsapp_handoff_declined: { label: "WhatsApp no se pudo ofrecer o el cliente lo rechazó", tone: "warn" },
  handoff_completed: { label: "Enviado por WhatsApp", tone: "ok" },
  handoff_failed: { label: "Falló el envío por WhatsApp", tone: "danger" },
